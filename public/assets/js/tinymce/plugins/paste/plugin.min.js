    ...
    r(l, [c, d, u], function (e, t, n) {
        ...
        return function (r) {
            ...
            function a() {
                ...
                s(), p = e.add(r.getBody(), "div", {id: "mcepastebin", contentEditable: !0, "data-mce-bogus": "1", style: "position: fixed; top: 20px;width: 10px; height: " + (i - 40) + "px; overflow: hidden; opacity: 0"}, g), e.setStyle(p, "left", "rtl" == e.getStyle(t, "direction", !0) ? 65535 : -65535), e.bind(p, "beforedeactivate focusin focusout", function (e) {
                    e.stopPropagation()
            ...
            s.on("BeforePastePreProcess", function (c) {
                ...
                if (p = l.paste_retain_style_properties, p && (m = e.makeMap(p)), l.paste_enable_default_filters !== !1 && a(c.content)) {
                    ...
                    v.addAttributeFilter("style", function (e) {
                        ...
                        for (var t = e.length, n, r, i; t--;)n = e[t], r = n.attr("href"), i = n.attr("name"), r && 0 === r.indexOf("file://") && (r = r.split("#")[1], r && (r = "#" + r)), r || i ? n.attr({href: r, name: i}) : n.unwrap()
                    });
                    var y = v.parse(f);
