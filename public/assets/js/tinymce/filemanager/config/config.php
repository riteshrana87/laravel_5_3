...
$base_url = "http://" . $_SERVER['HTTP_HOST'] . "/assets"; // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir = '/uploads/tinymce/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../uploads/tinymce/source/'; // relative path from filemanager folder to upload folder (with final /)
