                    ...
                    <div class="filters">
                        <div class="row-fluid">
                            ...
                            <div class="span6 types">
                                ...
                                <?php } ?>
                                <input accesskey="f" type="text" class="filter-input" id="filter-input" name="filter"
                ...
                <?php } else { ?>
                    ...
                    <figcaption>
                        <a href="javascript:void('')"
                           ...
                           title="<?php echo lang_Rename ?>" data-path="<?php echo $subfolder . $subdir . $file; ?>"
                        ...
                        <a href="javascript:void('')"
                           ...
                           data-path="<?php echo $subfolder . $subdir . $file; ?>"
                           data-thumb="<?php echo $thumbs_path . $subdir . $file; ?>">
    ...
    <li class="ff-item-type-<?php echo $class_ext; ?> file" data-name="<?php echo $file; ?>">
        <figure data-name="<?php echo $file ?>" data-type="<?php if ($is_img) {
            ...
            <a href="javascript:void('')" class="link" data-file="<?php echo $file; ?>"
               data-field_id="<?php echo $_GET['field_id']; ?>" data-function="<?php echo $apply; ?>">
                <div class="img-precontainer">
                ...
                <form action="force_download.php" method="post" class="download-form" id="form<?php echo $nu; ?>">
                    ...
                    <?php } elseif (($is_video || $is_audio) && in_array($extension_lower, $jplayer_ext)) { ?>
                        <a class="tip-right modalAV <?php if ($is_audio) {
                           ...
                           data-url="ajax_calls.php?action=media_preview&title=<?php echo $filename; ?>&file=<?php echo $current_path . $subfolder . $subdir . $file;; ?>"
