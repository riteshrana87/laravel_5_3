...
(function () {
        ...
        return{define: function (c, f) {
            ...
            once: function () {
                ...
                return function (j, l, h) {
                    ...
                    if (n) {
                        var y = n.listeners;
                        if (y.length)for (var y = y.slice(0), z, o = 0; o < y.length; o++) {
                            if (n.errorProof)try {
                                z = y[o].call(this,
                                    h, l, f, b)
                            } catch (r) {
                            } else z = y[o].call(this, h, l, f, b);
    ...
    (function () {
        ...
        CKEDITOR.tools = {arrayCompare: function (a, f) {
            ...
            htmlEncode: function (a) {
                ...
                return a.replace(g, "&").replace(j, ">").replace(l, "<")
            }, htmlEncodeAttr: function (a) {
                return a.replace(d, "&quot;").replace(f, "&lt;").replace(c, "&gt;")
            }, htmlDecodeAttr: function (a) {
                return a.replace(h, '"').replace(l, "<").replace(j, ">")
    ...
    (function () {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {type: CKEDITOR.NODE_ELEMENT, addClass: function (a) {
            ...
            if (!d.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                ...
                for (var d = [], e = 0; e < b.length; e++)if (c)for (var h = 0; h < c.length; h++)d.push([a, b[e], c[h]].join("-")); else d.push([a, b[e]].join("-"));
            ...
            copyAttributes: function (a, b) {
                for (var c = this.$.attributes, b = b || {}, e = 0; e < c.length; e++) {
                    ...
                    if (!(h in b))if (h == "checked" && (n = this.getAttribute(h)))a.setAttribute(h, n); else if (!CKEDITOR.env.ie || this.hasAttribute(h)) {
                ...
                if (e !== false)for (var c = this.getChildren(), l = 0; l < c.count(); l++) {
                    e = c.getItem(l);
    ...
    (function () {
        function a(a, b) {
            ...
            if (a && !this._.guardRTL) {
                ...
                this._.guardRTL = function (a, b) {
                    return(!b || !g.equals(a)) && (!h || !a.equals(h)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            var F = a ? this._.guardRTL : this._.guardLTR;
            i = m ? function (a, b) {
                return F(a, b) === false ? false : m(a, b)
            } : F;
            if (this.current)d = this.current[s](false, k, i); else {
                if (a)d.type ==
                    CKEDITOR.NODE_ELEMENT && (d = n > 0 ? d.getChild(n - 1) : i(d, true) === false ? null : d.getPreviousSourceNode(true, k, i)); else {
                    d = e;
        ...
        CKEDITOR.dom.element.prototype.getBogus = function () {
            var a = this;
            do a = a.getPreviousSourceNode(); while (j(a) || g(a) || a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty));
    ...
    (function () {
        ...
        var c = function (a) {
            ...
            } else if (q)if (q >= e.getChildCount()) {
                e = e.append(a.document.createText(""));
                i = true
            } else e = e.getChild(q).getPrevious(); else {
            ...
            for (var p = c, h, l, F, j = k; j < q.length; j++) {
                ...
                for (h = h.getNext(); h;) {
                    ...
                    F = h.getNext();
                    if (b == 2)p.append(h.clone(true)); else {
                        h.remove();
                        b == 1 && p.append(h)
                    }
                    h = F
            ...
            for (c = k; c < g.length; c++) {
                ...
                if (!q[c] || h.$.parentNode != q[c].$.parentNode)for (h = h.getPrevious(); h;) {
                    if (h.equals(q[c]) || h.equals(e))break;
                    F = h.getPrevious();
                    if (b == 2)p.$.insertBefore(h.$.cloneNode(true), p.$.firstChild); else {
                        h.remove();
        ...
        {clone: function () {
            ...
            switch (a) {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        for (; k;) {
                            ...
                            if (k.type == CKEDITOR.NODE_COMMENT)k = k.getPrevious(); else {
                                if (k.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    0 || b && k.is("br")) && !k.data("cke-bookmark"))if (u && CKEDITOR.dtd.$removeEmpty[k.getName()]) {
                                    h = k.getText();
                                    if (d.test(h))k = null; else for (var l = k.$.getElementsByTagName("*"), F = 0, j; j = l[F++];)if (!CKEDITOR.dtd.$removeEmpty[j.nodeName.toLowerCase()]) {
                                        k = null;
                                        break
                                    }
                                    k && (p = !!h.length)
                    ...
                    if (p.type == CKEDITOR.NODE_TEXT)if (CKEDITOR.tools.trim(p.substring(l)).length)u = true; else {
                        u = !p.getLength();
                        if (l == p.getLength()) {
                            if (!(k = p.getNext()))m = p.getParent()
                        } else L(p,
                            l) && (m = p.getParent())
                    } else(k = p.getChild(l)) || (m = p);
                    for (; m || k;) {
                        if (m && !k) {
                            !s && m.equals(f) && (s = true);
                            if (e ? m.isBlockBoundary() : !q.contains(m))break;
                        ...
                        for (; k;) {
                            ...
                            if (k.type == CKEDITOR.NODE_TEXT) {
                                ...
                                if ((k.$.offsetWidth > 0 || b && k.is("br")) && !k.data("cke-bookmark"))if (u && CKEDITOR.dtd.$removeEmpty[k.getName()]) {
                                    h = k.getText();
                                    if (d.test(h))k = null; else {
            ...
            if (!this.collapsed) {
                ...
                if (e && e.type == CKEDITOR.NODE_TEXT)if (q)if (q >= e.getLength())d.setStartAfter(e); else {
                    d.setStartBefore(e);
                    i = 0
                } else d.setStartBefore(e);
                if (f && f.type == CKEDITOR.NODE_TEXT)if (g)if (g >= f.getLength())d.setEndAfter(f); else {
                    d.setEndAfter(f);
                    m = 0
    ...
    (function () {
        ...
        var d = /^[\r\n\t ]+$/, g = CKEDITOR.dom.walker.bookmark(false, true), j = CKEDITOR.dom.walker.whitespaces(true), l = function (a) {
            return g(a) && j(a)
        }, h = {dd: 1, dt: 1, li: 1};
        a.prototype = {getNextParagraph: function (a) {
            ...
            for (this._.nextNode =
                ...
                if (k)x.type == CKEDITOR.NODE_TEXT && d.test(x.getText()) && (k = 0); else {
                    var u = x.getName();
                    if (CKEDITOR.dtd.$block[u] && x.getAttribute("contenteditable") == "false") {
                        ...
                        if (u == "br")k = 1; else if (!j && !x.getChildCount() && u != "hr") {
                            b = x;
                            z = x.equals(q);
                            break
                        }
            ...
            if (!b) {
                ...
                i = {div: 1, th: 1, td: 1};
                b = b.block;
                if (!b && x && !this.enforceRealBlocks && i[x.getName()] && j.checkStartOfBlock() && j.checkEndOfBlock() && !x.equals(j.root))b = x; else if (!b || this.enforceRealBlocks && b.is(h)) {
            ...
            if (r)(o = b.getLast()) && o.type == CKEDITOR.NODE_ELEMENT && o.getName() == "br" && (!CKEDITOR.env.needsBrFiller || o.getPrevious(g) || o.getNext(g)) &&
            o.remove();
    ...
    (function () {
        function a(a, b, c, d, e) {
            ...
            for (var b = e.elements, e = e.generic, h, c = 0, d = a.length; c < d; ++c) {
                ...
                if (f.elements === true || f.elements === null)e[k ? "unshift" : "push"](f); else {
                    i = f.elements;
                    delete f.elements;
                    for (h in i)if (b[h])b[h][k ? "unshift" : "push"](f); else b[h] = [f]
                }
            }
        }

        function e(a, c, d, e) {
            if (!a.match || a.match(c))if (e || j(a, c)) {
        ...
        function z(a, b, d, f) {
            ...
            if (f.doTransform)if (i = a._.transformations[b.name]) {
                y(b);
            ...
            if (f.doFilter) {
                ...
                if (!a.allAttributes)for (v in m)if (!g[v])if (E.test(v)) {
        ...
        function k(a, b, c) {
            var d = a.name;
            if (F.$empty[d] || !a.children.length)if (d == "hr" && b == "br")a.replaceWith(i()); else {
                a.parent && c.push({check: "it", el: a.parent});
                a.remove()
            } else if (F.$block[d] || d == "tr")if (b == "br") {
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return{load: function (b, c, f, d) {
            ...
            g && (b = [b]);
            f || (f = CKEDITOR);
            var j = b.length, l = [], h = [], n = function (a) {
                c && (g ? c.call(f, a) : c.call(f, l, h))
            };
            if (j === 0)n(true); else {
                var t = function (a, b) {
                    (b ? l : h).push(a);
        ...
        function n(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                for (var i in c) {
                    ...
                    if (h && (w = h.match(k)))for (; h = w.pop();)CKEDITOR.tools.setTimeout(function (a, b) {
                    ...
                    if (g && !a.lang[i]) {
                        ...
                        if (!m.langEntries || !m.langEntries[q])f.push(CKEDITOR.getUrl(m.path + "lang/" + q + ".js")); else {
            ...
            function (d, g, j) {
                ...
                o.onTagOpen = function (d, f, p, r) {
                    ...
                    if (a(f))q.push(f); else {
                        ...
                        if (d == "br")x.push(f); else {
                            for (; ;) {
                                r = (p = i.name) ? CKEDITOR.dtd[p] || (i._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                                if (!f.isUnknown && !i.isUnknown && !r[d])if (i.isOptionalClose)o.onTagClose(p); else if (d in b && p in b) {
                                    p = i.children;
                                    (p = p[p.length - 1]) && p.name == "li" || t(p = new CKEDITOR.htmlParser.element("li"), i);
                                    !f.returnPoint && (f.returnPoint = i);
                                    i = p
                                } else if (d in CKEDITOR.dtd.$listItem && !z(d, p))o.onTagOpen(d == "li" ? "ul" : "dl", {}, 0, 1); else if (p in e && !z(d, p)) {
                                    !f.returnPoint && (f.returnPoint = i);
                                    i = i.parent
                                } else {
                                    p in CKEDITOR.dtd.$inline && q.unshift(i);
                                    if (i.parent)t(i, i.parent, 1); else {
                                        f.isOrphan = 1;
                                        break
                                    }
                                } else break
    ...
    (function () {
                ...
                return function (f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (i)for (r(i, 1) && k.push(i); i;) {
                            if (d(i) && (p = c(i)) && r(p))if ((A = c(p)) && !d(A))k.push(p); else {
                                m(s).insertAfter(p);
                                p.remove()
                            }
                            i = i.previous
                        ...
                        if (k = (typeof e == "function" ? e(f) : e) !== false)if (!s && !CKEDITOR.env.needsBrFiller &&
                            f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)k = false; else if (!s && !CKEDITOR.env.needsBrFiller && (document.documentMode > 7 || f.name in CKEDITOR.dtd.tr || f.name in CKEDITOR.dtd.$listItem))k = false; else {
                            k = b(f);
        ...
        function h(a) {
            return a.replace(S, function (a, b, c) {
                return"<" + b + c.replace(F, function (a, b) {
                    return J.test(b) && c.indexOf("data-cke-saved-" + b) == -1 ? " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a : a
                }) + ">"
            })
        }
        ...
        var q = /(?:&nbsp;|\xa0)$/, x = "{cke_protected}", i = CKEDITOR.dtd, m = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], k = CKEDITOR.tools.extend({}, i.$blockLimit, i.$block), s = {elements: {input: j, textarea: j}}, u = {attributeNames: [
            ...
            }, input: l, textarea: l}, attributes: {"class": function (a) {
    ...
    (function () {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({base: CKEDITOR.dom.element, $: function (a, b) {
            ...
            if (!b) {
                var e = /\n{2}/g;
                if (e.test(a))var f = "<" + c + ">", s = "</" + c + ">", a = f + a.replace(e, function () {
                    return s + f
                }) + s
            }
            a = a.replace(/\n/g, "<br>");
            ...
            var s, h;
            if (f)for (; (s = b.getCommonAncestor(0, 1)) && (h = CKEDITOR.dtd[s.getName()]) && (!h || !h[e]);)if (s.getName()in CKEDITOR.dtd.span)b.splitElement(s); else if (b.checkStartOfBlock() &&
                b.checkEndOfBlock()) {
                b.setStartBefore(s);
                b.collapse(true);
                s.remove()
            ...
            if (this.insertElementIntoRange(a, e)) {
                ...
                if (f)if ((f = a.getNext(function (a) {
                    return c(a) && !h(a)
                })) && f.type == CKEDITOR.NODE_ELEMENT && f.is(CKEDITOR.dtd.$block))f.getDtd()["#"] ?
                    e.moveToElementEditStart(f) : e.moveToElementEditEnd(a); else if (!f && d != CKEDITOR.ENTER_BR) {
                ...
                CKEDITOR.env.webkit && this.attachListener(a, "key", function (b) {
                    ...
                    if (b in m) {
                        ...
                        if (d.collapsed) {
                            ...
                            e = b.block;
                            h = c.endPath().block;
                            if (!e || !h || e.equals(h))b = false; else {
                                a.fire("saveSnapshot");
        ...
        var z = function () {
            ...
            function b(c, d) {
                ...
                for (var p = h[p.getName()], C = 0, g = c.getChildren(), j = g.count(), l = -1, n = -1, u = 0, o = e.contains(h.$list); C < j; ++C) {
                    ...
                    if (a(e)) {
                        i = e.getName();
                        if (o && i in CKEDITOR.dtd.$list)m = m.concat(b(e, d)); else {
                            k = !!p[i];
                    ...
                    if (v) {
                        ...
                        for (k(C, G); v < C.length; v++) {
                            ...
                            if (D = A.isLineBreak) {
                                ...
                                if (A.hasBlockSibling)D = 1; else {
                                    N = D.startContainer.getAscendant(h.$block, 1);
                                    if (!N || !N.is({div: 1, p: 1}))D = 0; else {
                                        W = N.getPosition(M);
                                        if (W == CKEDITOR.POSITION_IDENTICAL || W == CKEDITOR.POSITION_CONTAINS)D = 0; else {
                                            M = D.splitElement(N);
    ...
    (function () {
        ...
        CKEDITOR.dom.selection = function (a) {
            ...
            if (CKEDITOR.env.webkit)(c.type == "None" && this.document.getActive().equals(a) || c.type == "Caret" && c.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && j(a, c); else if (CKEDITOR.env.gecko)c && (this.document.getActive().equals(a) && c.anchorNode && c.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && j(a, c, true); else if (CKEDITOR.env.ie) {
                b = this.document.getActive();
                if (r)c.type == "None" && (b && b.equals(this.document.getDocumentElement())) && j(a, null, true); else {
        ...
        CKEDITOR.dom.selection.prototype = {getNative: function () {
            return this._.cache.nativeSel !== void 0 ? this._.cache.nativeSel : this._.cache.nativeSel = r ? this.document.$.selection : this.document.getWindow().$.getSelection()
        }, getType: r ? function () {
            var a = this._.cache;
                ...
                var b = function (b, c) {
                    ...
                    for (var e = d.children, f, i, h = b.duplicate(), k = 0, g = e.length - 1, w = -1, j, v; k <= g;) {
                        ...
                        j = h.compareEndPoints("StartToStart",
                            b);
                        if (j > 0)g = w - 1; else if (j < 0)k = w + 1; else return{container: d, offset: a(f)}
                    }
                ...
                if (j && a.length > 1) {
                    ...
                    if (g)for (var h = 0; a[d + h + 1];) {
                        for (var n = j.document, g = 0, l = n.getById(e[h].endNode), n = n.getById(e[h +
                            ...
                            if (n.equals(l))g = 1; else if (c(l) || l.type == CKEDITOR.NODE_ELEMENT && l.isBlockBoundary())continue;
                            break
                        }
                        if (!g)break;
                        h++
    ...
    (function () {
        ...
        function ha(a) {
            var c = a.doc, d = B('<span contenteditable="false" style="' + L + "position:absolute;border-top:1px dashed " + a.boxColor + '"></span>', c), b = this.path + "images/" + (n.hidpi ? "hidpi/" : "") + "icon" + (a.rtl ? "-rtl" : "") +
                ".png";
            q(d, {attach: function () {
        ...
        function $(a) {
            ...
            if (c.y > e.size.top - 1 && c.y < e.size.top + b)i = !1; else if (c.y > e.size.bottom - b && c.y < e.size.bottom + 1)i = !0; else return null;
            ...
            } else e.equals(a.editable[i ? "getLast" : "getFirst"](a.isRelevant)) ? (C(a), i && c.y > e.size.bottom - b && c.y < d.pane.height && e.size.bottom > d.pane.height - b && e.size.bottom < d.pane.height ? g = y : 0 < c.y && c.y < e.size.top + b &&
                (g = x)) : g = s, f = [null, e][i ? "reverse" : "concat"]().concat([i ? Z : D, H, g, e.equals(a.editable[i ? "getLast" : "getFirst"](a.isRelevant)) ? i ? y : x : s]);
        ...
        function P(a, c, d, b) {
            ...
            }(), f = c.getDocumentPosition(), g = {}, i = {}, h = {}, j = {}, l = t.length; l--;)g[t[l]] = parseInt(e("border-" + t[l] + "-width"), 10) || 0, h[t[l]] =
                parseInt(e("padding-" + t[l]), 10) || 0, i[t[l]] = parseInt(e("margin-" + t[l]), 10) || 0;
            (!d || b) && I(a, b);
            ...
            return q({border: g, padding: h, margin: i, ignoreScroll: d},
                j, !0)
        }
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("undo", {init: function (a) {
            function b(a) {
                c.enabled && !1 !== a.data.command.canUndo && c.save()
            }
            ...
            var c = a.undoManager = new k(a), e = c.editingHandler = new l(c), f = a.addCommand("undo", {exec: function () {
                c.undo() && (a.selectionChange(), this.fire("afterUndo"))
            }, startDisabled: !0, canUndo: !1}), g = a.addCommand("redo", {exec: function () {
                c.redo() &&
            ...
            a.on("saveSnapshot", function (a) {
                c.save(a.data && a.data.contentOnly)
            });
        ...
        k.prototype = {keyGroupsEnum: {PRINTABLE: 0, FUNCTIONAL: 1}, strokesRecorded: [0, 0], navigationKeyCodes: {37: 1, 38: 1, 39: 1, 40: 1, 36: 1, 35: 1, 33: 1, 34: 1}, previousKeyGroup: -1, type: function (a) {
            ...
            undo: function () {
                ...
                return!!this.navigationKeyCodes[a]
            }};
        ...
        var f = 0, i = !1, n = function () {
            i = !0
        }, l = CKEDITOR.plugins.undo.NativeEditingHandler =
            function (a) {
                this.undoManager = a
            };
        l.prototype = {onKeydown: function (a) {
            if (-1 < CKEDITOR.tools.indexOf(h, a.data.getKeystroke()))a.data.preventDefault(); else {
            ...
            if (0 < f)f -= 1, b.type(a); else if (b.isNavigationKey(a))this.onNavigationKey(!0)
            ...
            a.attachListener(a, "click", function () {
                b.onNavigationKey()
            })
        }}
    })();
